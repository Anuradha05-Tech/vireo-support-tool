...
1. MODEL & PRICING TRACEABILITY:
   ...
   - Commercial Pricing Rate Basis      : $0.075/1M input tokens, $0.3/1M output tokens (USD/INR = 83.5).
   - Token Prompt Derivation per Ticket  : 150 input tokens + 30 output tokens = 180 tokens/ticket.
   - Commercial Rate Calculation        : (150/1M × $0.075 + 30/1M × $0.300) × ₹83.5 = ₹0.001691 INR / ticket (~0.17 paise/ticket).
...
3. COST-SCALING METHODOLOGY & MONTHLY TOOL OPERATING PROJECTIONS:
   - Methodology Explanation: The Category Tag Audit runs as a FIXED monthly sample of 100 tickets/month (fixed audit cost of ₹0.169/mo). The 'Already Told You' Language Sweep runs keyword pre-filtering on incoming monthly ticket volume at ₹0.00 marginal cost (0 LLM calls).
